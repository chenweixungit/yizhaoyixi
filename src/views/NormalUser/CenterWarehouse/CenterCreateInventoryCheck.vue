    ...
    <card id="select-area">
      <el-form :inline="true" ref="form" :model="form" label-width="80px">
        ...
        <el-form-item label="盘点日期">
          <el-date-picker class="selector" value-format="yyyy-MM-dd" type="date" placeholder="请选择日期" style="width: 100%;" v-model="form.checkDate"></el-date-picker>
        </el-form-item>
        <el-form-item label="创建人">
          <el-input class="selector"  v-model="form.creatorName"></el-input>
        </el-form-item>
      </el-form>
